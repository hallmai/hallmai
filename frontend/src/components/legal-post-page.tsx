  ...
  return (
    <AppShell>
      <header className="flex items-center px-5 h-14 border-b border-stone-200/40">
        <Link href="/auth/register" className="text-[14px] text-[#E8725C] font-medium">&larr; {t.legalBack}</Link>
      </header>
      <div className="flex-1 overflow-y-auto px-6 py-6">
        ...
        {loading ? (
          ...
          <p className="py-20 text-center text-stone-400">{t.legalPreparing}</p>
        ) : (
