    ...
    <div className="flex h-dvh justify-center bg-[#f2f1ef]">
      <div className="relative flex w-full max-w-[430px] flex-col h-dvh bg-[#FFF8F0]">
        ...
        <header className="sticky top-0 z-50 flex items-center justify-between px-5 h-12 bg-[#FFF8F0]/80 backdrop-blur-xl">
          <span className="text-[16px] font-bold tracking-tight text-stone-800">
            {t.brand}
          </span>
        ...
        <div className="absolute bottom-5 left-5 right-5 z-50">
          <nav className="flex rounded-2xl bg-[#FFF8F0]/80 backdrop-blur-xl shadow-lg shadow-stone-900/[0.08] border border-stone-200/40">
            <button className="flex-1 flex flex-col items-center gap-0.5 py-3">
              <svg className="w-5 h-5 text-[#E8725C]" fill="currentColor" viewBox="0 0 24 24">
                <path d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
              </svg>
              <span className="text-[10px] font-semibold text-[#E8725C]">{t.updatesTab}</span>
            </button>
            <button className="flex-1 flex flex-col items-center gap-0.5 py-3">
              ...
              <span className="text-[10px] font-medium text-stone-300">{t.settingsTab}</span>
            </button>
          </nav>
        </div>
      </div>
