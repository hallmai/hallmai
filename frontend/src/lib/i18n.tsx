...
const dictionaries = {
  en: {
    ...
    hotkeyCamera: "Camera",
    hotkeyCameraDesc: "Take a photo",
    cameraEndCallAlert: "The call will pause while you take a photo, then continue with the photo. Ready?",
    hotkeyHelp: "Help",
  ...
  ko: {
    ...
    hotkeyCamera: "카메라",
    hotkeyCameraDesc: "사진 찍기",
    cameraEndCallAlert: "대화를 잠깐 멈추고 사진을 찍을게요. 사진을 보내면 대화가 이어져요!",
    hotkeyHelp: "도움말",
