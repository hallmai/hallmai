	...
	return (
		<>
			...
			<header className="flex items-center justify-between px-5 h-14 border-b border-stone-200/40">
				...
				<button onClick={toggleLocale} className="text-[12px] font-semibold text-stone-400">
					{locale === 'ko' ? 'EN' : 'KO'}
				</button>
			</header>
...
function GuestSettings({ t, router }: { t: ReturnType<typeof useI18n>['t']; router: ReturnType<typeof useRouter> }) {
