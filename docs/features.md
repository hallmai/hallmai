...
| F-07 | 가족 온보딩 | 가족 연결(닉네임 입력 → 4자리 코드 입력) 전용 온보딩 화면 |
...
| F-45 | 앱 아이콘·파비콘 | 할마이 브랜드 아이콘·웹 파비콘·Capacitor 앱 아이콘·스플래시 적용 완료 |
...
| F-46 | Soul 지역 정보 저장 | Soul 프로필에 사는 지역 필드 추가, 대화에서 자동 추출 | F-29 ✅ |
| F-47 | 날씨 핫키 | 날씨 핫키 버튼 활성화, Soul 지역 정보 기반 날씨 안내 | F-46 |

## Backlog — Blocked (3)

| # | 기능 | 설명 | 대기 중 |
|---|------|------|---------|
| F-11 | 가족 답장/사진 전송 | 가족이 홈 화면에서 시니어에게 메시지/사진 보내기 | F-10 |
| F-12 | 시니어 앱 연결 가족 확인/해제 | 시니어 설정에서 연결된 가족 목록 확인 및 해제 | F-10 |
