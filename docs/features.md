...
| # | 기능 | 설명 |
|---|------|------|
| F-02 | 지난 대화 기억 | 대화 종료 시 요약 자동 생성, 다음 대화 시스템 프롬프트에 최근 3회 요약 주입 |
...
| F-32 | 시니어 친화 VAD 설정 | startOfSpeech HIGH, endOfSpeech LOW, prefixPadding 800ms, silenceDuration 2000ms |
...
| F-39 | 음성 볼륨 버튼 맥동 | 통화 중 실시간 오디오 볼륨에 따라 중앙 버튼 크기 맥동 | — |
