...
| F-02 | F-24 ✅ | 저장된 대화 transcript 활용 |
| F-03 | — | 외부 API(날씨/뉴스) 연동 |
| F-04 | F-07 | 온보딩에서 수집한 취미/관심사 필요 |
| F-05 | F-07 | 온보딩에서 수집한 가족 구성원 정보 필요 |
| F-06 | F-22 ✅ | 침묵 감지 위에 AI 판단 종료 추가 |
| F-07 | — | **핵심 블로커**: F-04, F-05, F-08, F-10, F-11, F-12 해제 |
| F-08 | F-07 | 온보딩 후 AI 성격 커스터마이징 |
| F-09 | — | TTS 독립 구현 |
